...
export default function EssentialStatsTable() {
  ...
  // Random stat generator (demo values)
            ...
            <tbody>
              {bulls.map((bull) => (
                <tr key={bull.id}>
                  ...
                  <td>{formatStat(randomStat(0, 5))}</td>
                  <td>{formatStat(randomStat(400, 700))}</td>
                  <td>{formatStat(randomStat(300, 600))}</td>
                  <td>{formatStat(randomStat(300, 600))}</td>
